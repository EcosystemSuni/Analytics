...
export const bar = from([
  new RetryLink(),
  new HttpLink({
    uri: "https://api.thegraph.com/subgraphs/name/edinsoncs/sunibar",
    shouldBatch: true,
  }),
]);
...
export const masterchef = from([
  new RetryLink(),
  new HttpLink({
    uri: "https://api.thegraph.com/subgraphs/name/edinsoncs/sunimaster",
    shouldBatch: true,
  }),
]);
...
export const exchange = from([
  new RetryLink(),
  new HttpLink({
    uri: "https://api.thegraph.com/subgraphs/name/edinsoncs/suniexchange",
    shouldBatch: true,
  }),
]);
